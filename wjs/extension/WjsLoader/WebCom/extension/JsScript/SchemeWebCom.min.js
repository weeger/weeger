...
// @require JsMethod > isPlainObject
// @require JsMethod > inheritProperty
(function(p){var q=/(?:{|%7B){2}((?:.(?!{|%7B))*)(?:}|%7D){2}/g;p.register("WebComScheme","SchemeWebCom",{classExtends:null,type:"WebCom",id:"",variables:{optionsInternal:{},optionsApplied:{},optionsDestroyed:{},optionsData:{},domChildren:{},classLoadsNames:["fadeIn","loaded","fadeOut","fadeOutChildren"],classLoads:{typeGlobal:!0},cssStyleNames:{},readyCallbacks:[],requiredInstances:{},webComConstruct:!1},options:{require:{defaults:!1,define:function(a,b,c){a.optionApply("dom",c);b&&(a.requiredInstances=
a.createInstances(b))},destroy:function(a,b){b&&a.destroyInstances(b,a.requiredInstances)}},urlHistory:{defaults:!1,unique:!1,define:function(a,b){if(b){var c=this.wjs,d=a.loader.type,e=c.urlQueryParse();e[d]=e[d]||{};this.unique?e[d]!==a.type&&(e[d]=a.type):e[d][a.id]=a.type;c.urlQueryReplace(e)}},destroy:function(a){var b=a.loader.type,c=this.wjs.urlQueryParse();c[b]&&(this.unique?delete c[b]:delete c[b][a.id],this.wjs.window.history.replaceState(null,null,"?"+this.wjs.urlQueryBuild(c)))}},cssClassInteraction:{defaults:null,
...
var b=this,c=function(){a.optionsData.cssFadeOut&&a.optionsData.cssFadeOut();a.__destructFadeOutOptionComplete()};this.wjs.wjsIncludeExit(a.dom,function(){b.wjs.webComExit(a.requiredInstances,function(){"number"===typeof a.classLoads.fadeOut?(a.__destructOptionsWaiting=!0,a.domClassLoadAdd("fadeOut",c)):c()})})}else a.__destructFadeOutOptionComplete()}}},optionsDefault:{},mixin:[],__construct:function(a){var b=this.wjs,c=0,d=[],e={},f;b.extendObject(e,this.optionsDefault);b.extendObject(e,a||{});
