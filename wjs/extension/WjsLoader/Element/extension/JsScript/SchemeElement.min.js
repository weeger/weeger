...
children:{autoInit:!1,define:function(a,b){var c=[];if("object"===typeof b)for(var d=Object.keys(b),f=0,e;e=b[d[f++]];)e=a.wjs.extendObject({},e),c.push(a.childAdd(e));return c}}},states:{playing:!1,renderEnabled:!0},__construct:function(a){this.__super("__construct",arguments);this.playFrameExecuteProxy=this.playFrameExecute.bind(this);this.formulaChangeCallback=this.frameNextEnable.bind(this);this.initElement(a);this.optionApply("children",a);this.render()},initElement:g._e,exitElement:g._e,exit:function(a){!1!==
