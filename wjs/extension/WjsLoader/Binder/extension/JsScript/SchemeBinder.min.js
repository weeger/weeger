...
(function(h){h.register("WebComScheme","SchemeBinder",{classExtends:"WebCom",type:"Binder",variables:{listeners:{},statesVars:{},stateConnected:{},stateListener:{}},states:{},options:{cssClasses:{define:function(a,b){b=b||[];if(a.loader.classLists[a.typeGlobal])return b.concat(a.loader.classLists[a.typeGlobal])}},cssFadeIn:{define:function(a,b,c){var e=0,d,f=a.loader;d=f.protoName(a.type);var g=f.domStyle[d];if(g)for(;d=f.classLists[a.typeGlobal][e++];)a.cssRulesClassSearch(g.sheet,d)&&(a.classLoads.typeGlobal=
!0);return this.__super("define",[a,b,c])}}},__construct:function(a){var b=this.loader.webCompSchemes[this.protoClassName];if(b.callbacks&&b.callbacks.domListen)for(var c=0,e=Object.keys(b.callbacks.domListen);b=e[c++];)b=this.methodName("callbacks.domListen."+b),this[b]=this[b].bind(this);this.__super("__construct",arguments);this.wjs.inheritLinage(this,"states")},callbackFind:function(a,b){return"function"===typeof a?a:this.method("callbacks."+b+"."+a)},domChildFill:function(a,b){this.__super("domChildFill",
arguments);this.trigger("domChildFill",[a,b])},domChildRemove:function(a){a=this.domChildGet(a);a.parentNode.removeChild(a)},domStyleGet:function(a){return this.wjs.window.getComputedStyle(this.dom,null).getPropertyValue(a)},domRect:function(){return this.dom.getBoundingClientRect()},stateSet:function(a,b,c){var e=this.states[a],d;if(b!==e){this.states.hasOwnProperty(a)||this.error("Trying to set undefined state "+a);d=this.callbackFind(a,"stateSet");this.states[a]=b;this.statesVars[a]=this.statesVars[a]||
{};this.wjs.extendObject(this.statesVars[a],c||{});if(d)this[this.methodName("callbacks.stateSet."+a)](b,c,e);this.trigger("stateSet",[a,b,e])}},stateGet:function(a){return this.states[a]},stateIs:function(a,b){"string"===typeof a&&(a={},a[a]=b);for(var c=0,e,d=Object.keys(a);e=d[c++];)if(this.states[e]!==a[e])return!1;return!0},stateListen:function(a,b,c,e){c=this.callbackFind(c,"stateListen");this.stateListener[a.id]=this.stateListener[a.id]||{};this.stateListener[a.id][b]=c;1===Object.keys(this.stateListener[a.id]).length&&
this.listen(a,"stateSet","stateListen");e&&c.apply(this,[a,b,a.stateGet(b)])},stateForget:function(a,b,c,e){var d=this.stateListener[a.id];c=this.callbackFind(c,"stateListen");e&&this.callbackFind(c,"stateListen").apply(this,[a,b,a.stateGet(b)]);delete d[b];0===Object.keys(d).length&&this.forget(a,"stateSet")},stateConnect:function(a,b,c,e){var d=this.stateConnected;d[a.id]=d[a.id]||{};d[a.id][b]=d[a.id][b]||[];d[a.id][b].push(c);this.stateListen(a,b,this.callbackFind("stateConnect","stateListen"),
